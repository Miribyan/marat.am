        ...
        <div className="bg-white">
            <header className="bg-white fixed w-full z-40">
                ...
                >
                    ...
                    <Dialog.Panel className=" fixed inset-y-0 right-0 z-50 w-2/3 overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 backdrop-blur-md">
            ...
            >
                <div className="flex flex-col md:flex-row w-full items-center mt-10 bg-gray-50 shadow-md rounded-xl p-3 mx-2 ">
                    <div className="w-full flex flex-col justify-center items-center z-20">
                        <div className="w-fit">
                            <h3 className="animate-typing overflow-hidden whitespace-nowrap border-r-4 border-r-black pr-5 text-4xl text-black  sm:text-5xl md:text-6xl lg:text-7xl font-semibold mb-10 leading-8  text-gray-900">
                                {"<Hello!/>"}
                            </h3>
                        </div>
            ...
            <div className="flex flex-col px-8">
                ...
                <div className="flex bg-yellow-300 text-white text-xl  py-10 justify-center items-center">
                        <p className="text-center -rotate-90">Lets talk</p>
                    </div>
                    <div className="w-full">
                        <p className="w-full text-sm sm:text-base md:text-xl text-center mb-5 bg-gray-50 p-1 shadow-sm">
